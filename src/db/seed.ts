...
const seedData = [
  { company: 'Acme Corp', role: 'Senior Frontend Engineer', status: 'interviewing', appliedDate: daysAgo(45), lastUpdated: today, source: 'linkedin', location: 'San Francisco, CA', workMode: 'hybrid', salaryMin: 140000, salaryMax: 180000, url: 'https://acme.com/jobs/1', contactName: 'Jane Smith', notes: 'Great culture, referral from a friend.' },
  ...
  { company: 'Los Pollos', role: 'Web Engineer', status: 'interviewing', appliedDate: daysAgo(30), lastUpdated: today, source: 'referral', location: 'Albuquerque, NM', workMode: 'onsite', salaryMin: 110000, salaryMax: 140000, url: null, contactName: 'Gustavo F.', notes: 'Third interview scheduled next week.' },
  ...
  { company: 'Sterling Cooper', role: 'Tech Lead', status: 'interviewing', appliedDate: daysAgo(22), lastUpdated: today, source: 'referral', location: 'New York, NY', workMode: 'hybrid', salaryMin: 170000, salaryMax: 220000, url: 'https://sterlingcooper.com/tech', contactName: 'Don D.', notes: 'Strong referral, feeling good about this one.' },
] as const
